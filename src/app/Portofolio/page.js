      ...
      <div className='flex-1'>
        ...
        <div className='galleries flex gap-16'>
          <Link href="/Portofolio/Illistrations" className='group image relative h-350 w-250 border-4 border-white'>
            ...
            <span className='absolute bottom-1 right-1 font-bold text-2xl cursor-pointer transition duration-250 ease-in text-white group-hover:text-green-600'>Illistrates</span>
          </Link>
          <Link href="/Portofolio/Websites" className='group image relative h-350 w-250 border-4 border-white'>
            ...
            <span className='absolute bottom-1 right-1 font-bold text-2xl cursor-pointer transition duration-250 ease-in text-white group-hover:text-green-600'>Websites</span>
          </Link>
          <Link href="/Portofolio/Apps" className='group image relative h-350 w-250 border-4 border-white'>
            ...
            <span className='absolute bottom-1 right-1 font-bold text-2xl cursor-pointer transition duration-250 ease-in text-white group-hover:text-green-600'>apps</span>
          </Link>
        </div>
      </div>
    </div>
