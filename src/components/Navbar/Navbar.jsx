            ...
            <li>
              <Link
                ...
                className="block py-2 pl-3 pr-4 
                 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 dark: md:dark:hover:text-green-500 dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
              >
                Portofolio
              </Link>
            </li>
